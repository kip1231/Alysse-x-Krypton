--[[
    ...
    KraSus Zet Source Code!
    By: Krutoy Suslik, Krain1771!
    KraSus Zet: [Kra]: Krain), [Sus]: Suslik) [Zet]: SLK Zet Team)
    Telegram Channel: https://t.me/KrutoySuslik
...
game:GetService("UserInputService").InputBegan:Connect(onKeyPress)
    ...
    trext1.Text = "[June 2nd.2024] KraSus Zet Release"
    trext1.TextSize = 7
    trext1.ZIndex = 4
    ...
    LogoM1.Size = UDim2.new(0, 50, 0, 49)
    LogoM1.Position = UDim2.new(0.5, -25, 0.5, -26)
    ...
    LogoM4.Size = UDim2.new(0, 35, 0, 35)
    LogoM4.Position = UDim2.new(0, 0, 0, 0)
    ...
    local LogoM4 = Instance.new("ImageLabel")
    LogoM4.Size = UDim2.new(0, 35, 0, 35)
    LogoM4.Position = UDim2.new(0.5, -18, 0.5, -25)
    LogoM4.BackgroundTransparency = 7
    LogoM4.Image = "rbxassetid://17263406285"
    LogoM4.ZIndex = 3
    LogoM4.Parent = Gui3o

	local LogM4 = Instance.new("TextButton")
    LogM4.Size = UDim2.new(0, 45, 0, 40)
    LogM4.Text = ""
    LogM4.Position = UDim2.new(0.5, -21, 0.5, -25)
    LogM4.BackgroundTransparency = 1
    LogM4.ZIndex = 3
    LogM4.Parent = Gui3o

	local frame3 = Instance.new("Frame")
	frame3.Size = UDim2.new(1, 0, 2, 0)
	frame3.Position = UDim2.new(0, 0, 0, -50) 
    ...
    LogoM5.Position = UDim2.new(0.5, -19, 0.5, 20)
    ...
    LogM5.Text = ""
    LogM5.Position = UDim2.new(0.5, -21, 0.5, 20)
	...
	LogM4.MouseButton1Click:Connect(function()
		frame1.Visible = false
		frame2.Visible = false
		frame3.Visible = true
		frame4.Visible = false
	...
	bo.Parent = frame3
	bo.Size = UDim2.new(0, 170, 0, 20)
	bo.Position = UDim2.new(0, 3, 0, 87)
	bo.Text = "Save Scripts"
	bo.TextSize = 15
	bo.TextColor3 = Color3.new(1, 1, 1)
	bo.BackgroundColor3 = Color3.fromRGB(30,30,30)
	...
	b1.Parent = frame3
	b1.Size = UDim2.new(0, 170, 0, 167)
	b1.Position = UDim2.new(0, 3, 0, 110)
	b1.Text = ""
	b1.TextSize = 15
	...
	b2.Parent = frame3
	b2.Size = UDim2.new(0, 170, 0, 80)
	b2.Position = UDim2.new(0, 178, 0, 89)
	b2.Text = ""
	b2.TextSize = 15
    ...
    local texxtBox = Instance.new("TextBox")
    texxtBox.Size = UDim2.new(0, 160, 0, 30)
    texxtBox.Position = UDim2.new(0,5,0,10)
    texxtBox.Text = "Script"
    texxtBox.Parent = b2
    texxtBox.BackgroundColor3 = Color3.fromRGB(30,30,30)
    texxtBox.ClearTextOnFocus = true
	texxtBox.TextColor3 = Color3.fromRGB(255, 255, 255)
	
	
	
    local te = Instance.new("TextBox")
    te.Size = UDim2.new(0, 75, 0, 30)
    te.Position = UDim2.new(0,5,0,45)
    te.Text = "Name Script"
    te.Parent = b2
    te.BackgroundColor3 = Color3.fromRGB(30,30,30)
    te.TextColor3 = Color3.fromRGB(255, 255, 255)

	local but1 = Instance.new("TextButton")
	but1.Parent = b2
	but1.Size = UDim2.new(0, 75, 0, 30)
	but1.Position = UDim2.new(0,89,0,45)
	but1.Text = "Save Script"
	but1.TextSize = 10
	but1.TextColor3 = Color3.new(1, 1, 1)
	but1.BackgroundColor3 = Color3.fromRGB(30,30,30)
	but1.BackgroundTransparency = 0.5
    	...
    	local buttonCount = 0
      if not isfolder(".Krasus/localscriptsposition/") then
        makefolder(".Krasus/localscriptsposition/")
      end
    	local function createNewButton()	
    		buttonCount = buttonCount + 1
    		  local fasfaf = te.Text
    	    local newButton = Instance.new("TextButton")
    	    newButton.Parent = b1
            newButton.Text = fasfaf
    	    newButton.Size = UDim2.new(0, 140, 0, 20)
    	    newButton.Position = UDim2.new(0, 10, 0, (buttonCount >= 1 and (buttonCount - 1) * 27 or 27))
      	  writefile("Krasus/localscripts/" .. te.Text .. ".txt", texxtBox.Text)
    	    ...
    	    corner.Parent = newButton
    		  local scriptString = texxtBox.Text
    	    ...
    	    deleteButton.Position = UDim2.new(0, 140, 0, 0)
    	    deleteButton.Text = "X"
     	   ...
     	   local corner = Instance.new("UICorner")
    	    corner.CornerRadius = UDim.new(0, 2)
    	    corner.Parent = deleteButton
    
    	    deleteButton.MouseButton1Click:Connect(function()
    	        deleteButton:Destroy() 
    	        newButton:Destroy()
    			buttonCount = buttonCount - 1
    			delfile(".Krasus/localscripts/" .. te.Text .. ".txt")
    	    end)
    	end
    	but1.MouseButton1Click:Connect(function()
    		createNewButton()
      ...
      if not isfolder("Krasus/localscripts") then
          makefolder("Krasus/localscripts")
      end

      local localscript = listfiles("Krasus/localscripts")
      if #localscript >= 1 then
      for i,v in pairs(localscript) do
      local newV = v:gsub("Krasus/localscripts/", "")
      newV = newV:gsub("%.txt$", "") 
      print (newV)
      local kolvo = #localscript
      buttonCount = kolvo
      		  local fasfaf = v
      		  local scripok = readfile(v)
    	    local newButton = Instance.new("TextButton")
    	    newButton.Parent = b1
    	    newButton.Size = UDim2.new(0, 140, 0, 20)
    	    newButton.Position = UDim2.new(0, 5, 0, (buttonCount >= 1 and (buttonCount - 1) * 27 or 27))
      	  newButton.Text = newV
       	  newButton.TextSize = 10
    	    newButton.TextColor3 = Color3.new(1, 1, 1)
    	    newButton.BackgroundColor3 = Color3.fromRGB(30,30,30)
    ...
    function change()
        if lan == "eng" then
            butto.Text = "List Of Updates"
            trext1.Text = "[02.06.2024] KraSus Zet Release"
            text51.Text = "Beta"
            text661.Text = "Do you want to close KraSus Zet without"
            text71.Text = "being able to open it again?"
            button11.Text = "No"
        ...
        elseif lan == "ru" then
            ...
            trext1.Text = "[02.06.2024] KraSus Zet Вышел"
            text51.Text = "Бета"
            ...
            bo.Text = "Сохранить Скрипт"
            texxtBox.Text = "Скрипт"
            te.Text = "Имя Скрипта"
            but1.Text = "Сохранить Скрипт"
            but1.TextSize = 7
    ...
    textBox.Position = UDim2.new(0.5, -90, 0.1, 0)
    textBox.Text = ""
    textBox.Parent = Gui1o
    textBox.Visible = false
    
    local ex = Instance.new("TextButton")
    ex.Size = UDim2.new(0, 100, 0, 30)
    ex.Position = UDim2.new(0.5, -50, 0.8, 0)
    ex.BackgroundColor3 = Color3.fromRGB(0, 255, 0)
    ex.Text = "Execute"
    ex.Parent = Gui1o
    ex.Visible = false
...
if isInGameMode() then -- If in the game then.
